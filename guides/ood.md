...
>**Step 1**: go to [SLAC ondemand](https://sdf.slac.stanford.edu/) + log in with your SLAC Windows username. To check if you have an Windows account (+ automatically request if you don't have one), [go here](https://oraweb.slac.stanford.edu/apex/slac/f?p=136).
